...
## Generated on : Fri May 19 01:22:46 2017
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Users\C3038028\WinPython-64bit-3.5.3.0Qt5\notebooks\SimulinkDLL\Example
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = dllModel_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = dllModel_ref.rsp
...
INCLUDES_BUILDINFO = $(START_DIR)\dllModel_ert_shrlib_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=dllModel -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\dllModel_ert_shrlib_rtw\dllModel.c $(START_DIR)\dllModel_ert_shrlib_rtw\dllModel_data.c
...
OBJS = dllModel.obj dllModel_data.obj
