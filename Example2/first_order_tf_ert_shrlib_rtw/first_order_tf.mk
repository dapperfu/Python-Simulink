...
## Generated on : Fri Feb 05 05:30:50 2021
...
COMPILER_COMMAND_FILE     = first_order_tf_comp.rsp
CMD_FILE                  = first_order_tf.rsp
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/first_order_tf_ert_shrlib_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=first_order_tf -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/first_order_tf_ert_shrlib_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/first_order_tf_ert_shrlib_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
